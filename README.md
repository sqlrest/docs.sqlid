[![docs](https://github.com/sqlrest/docs.sqlid/actions/workflows/docs.yml/badge.svg)](https://github.com/sqlrest/docs.sqlid/actions/workflows/docs.yml) [![pages](https://github.com/sqlrest/docs.sqlid/actions/workflows/pages.yml/badge.svg)](https://github.com/sqlrest/docs.sqlid/actions/workflows/pages.yml)

# docs.sqlid

The **public documentation** site for [`sqlrest/sqlid`](https://github.com/sqlrest/sqlid). Built from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs) as a self-contained [Hugo](https://gohugo.io) site, published to GitHub Pages.
